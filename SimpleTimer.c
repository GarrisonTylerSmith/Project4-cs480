 ...
 * @Note Changed GET_TIME_DIFF and START_TIME
 */
    ...
    switch( controlCode )
       {
        ...
        case RESET_TIMER:
           ...
           fpTime = 0.0;
           break;
// In the Simple timer I changed this and rearranged most of the code and 
// deleted maybe two lines of code to change it. 
        case GET_TIME_DIFF:
           if( running == True )
              {
               gettimeofday( &endData, NULL );
